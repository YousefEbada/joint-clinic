const WhoWeAre = () => {
  return (
    <section className="who_we_are flex justify-center items-center h-screen text-[#fff] flex-col md:mb-[0px] mb-50">
        <h2 className="text-[64px] text-center w-[100%] font-bold mb-[40px]">
          Who We Are
        </h2>
        <p className="text-center w-[90%] md:w-[46%] font-medium ">
